package com.xiaotaozi.autopilot.ui.theme
...
val DarkTaoziColors = TaoziColors(
    primary = Primary,
...
val LightTaoziColors = TaoziColors(
    primary = Primary,
    primaryDark = PrimaryDark,
    primaryLight = PrimaryLight,
    secondary = Secondary,
...
val LocalTaoziColors = staticCompositionLocalOf { DarkTaoziColors }
...
fun TaoziTheme(
    ...
    val taoziColors = if (isDarkTheme) DarkTaoziColors else LightTaoziColors

    CompositionLocalProvider(LocalTaoziColors provides taoziColors) {
        MaterialTheme(
...
object TaoziTheme {
    val colors: TaoziColors
        @Composable
        get() = LocalTaoziColors.current
}
